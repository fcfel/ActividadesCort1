     ...
     { 
       ...
       for(int n = 0;  n < emp; n++)
      {
       ...
       Tot2 = Tot2 + 1;
        ...
        //Resultado
       Console.Write("Cantidad de mujeres que ganan mas de 1.000.000: "+Tot1);
       Console.Write("Cantidad de hombres que ganan menos de 900.000: "+Tot2);
       Console.Write("La suma de los sueldos de las mujeres es: "+lz);
       Console.Write("La suma de los sueldos de los hombres es: "+rr);
    }
 }